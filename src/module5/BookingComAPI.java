...
public class BookingComAPI implements API{
    ...
    public BookingComAPI() {
        ...
        rooms[0] = new Room(1, 300, 2, new Date(2016, 10, 12), "Hotel1", "Kyiv");
        rooms[1] = new Room(2, 400, 3, new Date(2016, 8, 1), "Hotel2", "Kyiv");
        rooms[2] = new Room(3, 400, 3, new Date(2016, 11, 1), "Hotel2", "Kyiv");
        rooms[3] = new Room(4, 700, 3, new Date(2016, 4, 1), "Hotel3", "Dnipro");
        rooms[4] = new Room(5, 200, 1, new Date(2016, 10, 1), "Hotel4", "Dnipro");
    }
